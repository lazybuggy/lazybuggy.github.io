    ...
    <div className={styles.container}>
      ...
      <div className={projStyles.projectSection}>
        ...
        <ProjectCard colour="#A2A071" image="/static/faceoffProj.png">
          ...
          <p>
            Remember Dance Dance Revolution? This version puts your expressions
            to the test! Introducing FaceOff, a revolutionary game for anyone
            who wants to see how well they can express themselves.
          </p>
        </ProjectCard>
        <ProjectCard image="/static/stbProj.jpeg">
          <h3>
            <a target="_blank" href="https://github.com/lazybuggy/GameJam2018">
              Secure The Bag
            </a>
          </h3>
          <p>
            6 hours to build a game with the theme 'Freezing'. You're a theif
            and the objective is to make to the end and steal the prize without
            being caught. Goodluck.
          </p>
        </ProjectCard>
        <ProjectCard colour="#555C80" image="/static/fMasterProj.png">
          ...
          <p>
            ...
            website that allows for users to sign in, rate and review movies as
            well as view details on each movie.
          </p>
        </ProjectCard>
      </div>
      <Footer />
